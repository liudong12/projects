...
router.use(csrfProtection); //apply to middleware to the router. with this, i am now telling express, all the routers included in this router (router.use 里面的router) package here, should be protected by csrf protection (csrfProtection).
