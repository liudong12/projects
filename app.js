...
//全局加载 helper:第一步：(写在app.js里面的)
// var hbs = expressHbs.create({
//     // Specify helpers which are only registered on this instance.
//     helpers: {
//         liu: function () { return 'liu!'; },
//         dong: function () { return 'dong!'; }
//     }
// });
// 
//(写在./helpers/handlebars里面的) 用这种写法替代上面的这种写法
...
//全局加载 helper:第二步：
app.engine('.hbs', hbs.engine);//引擎的名字叫 handlebars，hbs 对象来自第一步 //这种写法在helper里面配置defaultLayout和extname
app.set('view engine', '.hbs');//使用上面这句话生成的引擎对象handlebars


// app.engine('.hbs', expressHbs({//废弃
...
// app.use(function(err, req, res, next) { console.log("aaa");
